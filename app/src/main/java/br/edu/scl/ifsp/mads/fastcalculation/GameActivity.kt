...
import br.edu.scl.ifsp.mads.fastcalculation.Extras.EXTRA_SETTINGS
import br.edu.scl.ifsp.mads.fastcalculation.databinding.ActivityGameBinding
...
class GameActivity : AppCompatActivity(), GameManager {
    ...
    override fun onEndGame(points: Float) {
        supportFragmentManager.beginTransaction()
            .replace(R.id.gameFl, GameResultFragment.newInstance(points)).commit()
    }
}